  ...
  var buildersArray = [
    {
      name: "male",
      dialogue:
        "يلا نلعب !, حل اللغز وجمع المفاتيح عشان تفوز , ونتبه من الالغام<br/> Clue 1: يا وردتي يا ندية،، روحي لخلي....",
    },
    {
      name: "giftBox",
    ...
    },
    {
      name: "sun",
      dialogue:
        "صباح الخير 🌞🌞<br/>مفتاح : O <br/> Clue 5: اذا طاح الجمل كثرت سجاجينة",
    },
    {
      name: "kinfe",
      dialogue:
        "لا تجرح نفسك 🔪🔪! <br/>مفتاح : N <br/> احسنت !! فزت باللعبه",
    },
